...
def test_add_book_with_long_name(collector):
    long_name = "a" * 41
...
def test_get_book_genre(collector, book_name, genre):
    collector.add_new_book(book_name)
    collector.set_book_genre(book_name, genre)
    assert collector.get_book_genre(book_name) == genre
...
def test_get_books_for_children(collector, book_name, genre, expected):
    collector.add_new_book(book_name)
    collector.set_book_genre(book_name, genre)
